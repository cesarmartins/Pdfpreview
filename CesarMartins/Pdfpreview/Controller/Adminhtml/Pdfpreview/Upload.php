...
class Upload extends \Magento\Backend\App\Action
{
    ...
    public function __construct(
        ...
        \CesarMartins\Pdfpreview\Model\Pdfpreview\ImageUploader $imageUploader
    ) {
    ...
    {
        //return $this->_authorization->isAllowed('CesarMartins_Pdfpreview::banner_read') || $this->_authorization->isAllowed('CesarMartins_Pdfpreview::banner_create');
        return true;
    }
