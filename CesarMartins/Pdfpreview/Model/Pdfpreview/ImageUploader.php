...
class ImageUploader
{
    ...
    const DEFAULT_BASETMPATH = "pdfpreview/tmp";
    const DEFAULT_BASEPATH = "pdfpreview";
    ...
    public function __construct(
        ...
        $this->allowedExtensions = ($allowedExtensions != null) ? $allowedExtensions : ['jpg', 'jpeg', 'gif', 'png', 'svg','pdf'];
    }
